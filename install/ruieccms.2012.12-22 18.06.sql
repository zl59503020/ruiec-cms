...
INSERT INTO `ruiec_category` VALUES (7,18,'IT资讯','function','list.php?catid=7',0,0,'','','','bbbbb','ccccccccccccccccccccccc'),(15,18,'数码产品','shuma','list.php?catid=15',0,0,'','','','',''),(16,18,'平板电脑','pingban','list.php?catid=16',15,0,'','','','',''),(19,18,'软媒动态','meiti','list.php?catid=19',7,0,'','','','',''),(20,18,'智能手机','phone','list.php?catid=20',15,0,'','','','',''),(21,18,'科技要闻','keji','list.php?catid=21',7,0,'','','','',''),(22,18,'笔记本电脑','bijiben','list.php?catid=22',15,0,'','','','',''),(23,19,'源码分享','source','list.php?catid=23',0,0,'','','','','');
...
CREATE TABLE `ruiec_down_19` (
  ...
  KEY `addtime` (`addtime`),
  KEY `catid` (`catid`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='资源共享';
...
INSERT INTO `ruiec_down_19` VALUES (10,23,1,'Ruiec JavaScript 库.','http://192.168.1.3/file/upload/2012/12/22//13561607404210.rar','ruiec.js ','<p>ruiec.js &nbsp;<img src=\"http://192.168.1.3/file/upload/2012/12/22/15-19-27-94-1.gif\" /></p>','','Ruiec JavaScript 库.,源码分享','','','',1,0,'',1356160767,1356160767,'192.168.1.3','',3,0,'show.php?itemid=10','','');
