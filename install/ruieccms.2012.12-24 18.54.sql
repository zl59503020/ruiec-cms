...
INSERT INTO `ruiec_down_19` VALUES (10,23,1,'Ruiec JavaScript 库.','http://192.168.1.3/file/upload/2012/12/22//13561607404210.rar','ruiec.js ','<p>ruiec.js &nbsp;<img src=\"http://192.168.1.3/file/upload/2012/12/22/15-19-27-94-1.gif\" /></p>','','Ruiec JavaScript 库.,源码分享','','','',2,0,'',1356160767,1356160767,'192.168.1.3','',3,0,'show.php?itemid=10','','');
...
CREATE TABLE `ruiec_fields` (
  ...
  `other` text COMMENT '其它',
  PRIMARY KEY (`itemid`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='自定义字段表';
