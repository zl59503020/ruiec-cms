				...
				<table class="form_table">
					...
					<tbody>
						...
						<tr>
							<th>图片：</th>
							<td>
								<input type="text" id="images" name="post[images][]" class="txtInput normal f_l" />
								<span><a href="javascript:upfile('images');" class="files"></a></span>
								<span style="margin:0px 5px;"><a href="javascript:showImg($('#images').val());">预览</a></span>
							</td>
						</tr>
					</tbody>
					<tbody id="locttbd">
