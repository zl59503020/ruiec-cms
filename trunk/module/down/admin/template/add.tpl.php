				...
				<table class="form_table">
					...
					<tbody id="locttbd">
						<tr>
							<th>资源链接[下载地址]：</th>
							<td>
								<input type="text" id="downurl" name="post[downurl]" class="txtInput normal f_l" />
					...
					<tbody>
						...
						<tr>
							<th>浏览次数:</th>
							<td>
								<input name="post[hits]" type="text" size="10" value="0" class="txtInput" />
								下载次数:
								<input name="post[downcount]" type="text" size="10" value="0" class="txtInput" />
							</td>
						</tr>
						<tr>
							<th>内容模板:</th>
