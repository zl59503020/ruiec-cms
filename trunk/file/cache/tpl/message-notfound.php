...
<li>直接访问<a href="<?php echo $MOD['linkurl'];?>" style="color:#1e50a2"><?php echo $MOD['name'];?>首页</a></li>
<li>系统在 <span id="sp_time" style="color:red;"><script type="text/javascript">document.write(tm);</script></span> 秒后自动返回<a href="<?php echo $MOD['linkurl'];?>" style="color:#1e50a2"><?php echo $MOD['name'];?>首页</a></li>
</ol>
</div>
...
<!-- <meta http-equiv="refresh" content="10; url=<?php echo $MOD['linkurl'];?>"> -->
<script>
function djs(){
tm = tm-1;
document.getElementById('sp_time').innerHTML = tm;
if(tm > 0) setTimeout('djs()',1000);
else window.location = '<?php echo $MOD['linkurl'];?>';
}
djs();
</script>
