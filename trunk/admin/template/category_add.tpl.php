...
<script type="text/javascript">
	...
	function ckDir(){
		if($('#catdir').val() == ''){
			...
			var url = '?file=<?php echo $file;?>&action=ckdir&catdir='+$('#catdir').val()+'&v_ruiec_ckdir=ruiec';
			$.ajax({
				url:url,
				...
				<table class="form_table">
					...
					<tbody>
						<tr>
							<th>上级分类</th>
							<td>
								<?php echo category_select('category[parentid]', '请选择', $parentid, $mid);?><?php tips('如果不选择，则为顶级分类');?>
							</td>
						</tr>
						<tr>
							<th>分类名称</th>
