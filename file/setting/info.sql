DROP TABLE IF EXISTS `ruiec_info_6`;
CREATE TABLE `ruiec_info_6` (
  ...
  KEY `addtime` (`addtime`),
  KEY `catid` (`catid`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='信息';

DROP TABLE IF EXISTS `ruiec_info_data_6`;
CREATE TABLE `ruiec_info_data_6` (
  `itemid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '信息ID',
  `content` longtext NOT NULL COMMENT '内容',
  PRIMARY KEY (`itemid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='信息内容';