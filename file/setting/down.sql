DROP TABLE IF EXISTS `ruiec_down_9`;
CREATE TABLE `ruiec_down_9` (
  ...
  `downurl` varchar(500) NOT NULL DEFAULT '' COMMENT '下载链接',
  ...
  KEY `addtime` (`addtime`),
  KEY `catid` (`catid`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='下载';
