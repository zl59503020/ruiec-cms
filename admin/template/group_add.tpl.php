				...
				<table class="form_table">
					...
					<tbody>
						<tr>
							<th>分组名称</th>
							<td>
								<input type="text" name="post[name]" value="" size="10" class="txtInput normal required" />
							</td>
						</tr>
						<tr>
							<th>权限管理</th>
							<td>
								...
								<ul class="cpul">
						<?php	foreach($_glob_cps as $k=>$v){ ?>
									<li>
										<input type="checkbox" name="post[competence][<?php echo $k; ?>]" value="1" /><?php echo $v; ?>
									</li>
						<?php	} ?>
								</ul>
								<div class="clr"></div>
...
?>
									<tr>
										...
										<td><input type="checkbox" name="<?php echo $mdck; ?>[insert]" value="1" _o="insert" />(INSERT)</td>
										<td><input type="checkbox" name="<?php echo $mdck; ?>[delete]" value="1" _o="delete" />(DELETE)</td>
										<td><input type="checkbox" name="<?php echo $mdck; ?>[update]" value="1" _o="update" />(UPDATE)</td>
										<td><input type="checkbox" name="<?php echo $mdck; ?>[select]" value="1" _o="select" />(SELECT)</td>
										<td><input type="checkbox" name="<?php echo $mdck; ?>[setting]" value="1" _o="setting" />(SETTING)</td>
									</tr>
<?php
								}
?>
