...
?>
	...
	<div class="tab_nav tab_nav_ex">新建模板</div>
	...
	<form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
		...
		<table class="form_table">
			...
			<tbody>
				...
				<tr>
					<th>模板名称: </th>
					<td>
						<input type="text" size="20" name="name" value="<?php if(isset($type)) echo $type;?>" class="txtInput normal required" />
						<?php echo tips("可以为中文"); ?>
					</td>
				</tr>
				<tr>
					<th>文件名: </th>
					<td>
						<input type="text" size="20" name="fileid" value="<?php if(isset($type)) echo $type.'-';?>" class="txtInput normal required" />.htm 
		...
		<div class="foot_btn_box" style="text-align:left;">
			...
			<input type="checkbox" name="nowrite" value="1" checked/> 如果模板已经存在,请不要覆盖&nbsp;&nbsp;
